...
<g:form action = "save" >
    ...
    <g:field  class ="input_sub_largo" type="text" placeholder="CodigoDeBarras"  name="email" onclick="elementoVisible('texto2')" required = "true" />

    <br><br>

    <p>
        <label class="fuenteCursiva" id="texto3" style="display:none">Precio</label><br>
        <g:field  class ="input_sub_corto" type="text" placeholder="Precio" name="nombreEmpresa" onclick="elementoVisible('texto3')"/>
