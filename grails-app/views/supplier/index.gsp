...
<g:form action = "sigin" >
    <p>
        <label class="fuenteCursiva" id="texto"  style="display:none">Nombre de la empresa</label>
        <!--g:field type="text" placeholder="Nombre y Apellido"  name="nombre"/--><br>
        <g:field   id="nomyAp" class="input_sub_largo" type="text" placeholder="Nombre de la empresa"  name="nombre" onclick="elementoVisible('texto')" required ="true" />
        <br><br>
        <!--input2 type="text" class="InputSinBordes" value= "Nombre"-->
    </p>
     <p>
        <label class="fuenteCursiva" id="texto"  style="display:none">Direccion</label>
        <g:field   id="nomyAp" class="input_sub_largo" type="text" placeholder="Direccion"  name="nombre" onclick="elementoVisible('texto')" required ="true" />
        <br><br>
    ...
    <p>
        ...
        <g:field  class ="input_sub_corto" type="text" placeholder="CUIT" name="nombreEmpresa" onclick="elementoVisible('texto3')"/>
